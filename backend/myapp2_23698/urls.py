"""myapp2_23698 URL Configuration
...
admin.site.site_header = "MyApp2"
admin.site.site_title = "MyApp2 Admin Portal"
admin.site.index_title = "MyApp2 Admin"

# swagger
api_info = openapi.Info(
    title="MyApp2 API",
    default_version="v1",
    description="API documentation for MyApp2 App",
)
